...
import { useGroups } from '../hooks/useSplits';
import { Plus, Search, Calendar, ChevronRight, Heart, Loader2 } from 'lucide-react';
            ...
            {filteredGroups.map((group) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                  ...
                  <div className="flex items-center gap-1.5 text-[9px] text-slate-400 font-bold uppercase tracking-wider"><Calendar size={12} />{format(group.createdAt, 'MMM yyyy')}</div>
                </div>
              </Link>
            ))}
