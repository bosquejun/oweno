...
import { Sparkles, ArrowRight, ShieldCheck, Zap, Heart, Star, Layout, Users, Receipt, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F8FAFC] overflow-x-hidden selection:bg-emerald-100 selection:text-emerald-900">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="px-6 py-3 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-xl active:scale-95"
            >
              Join Now
            </button>
          </div>
      ...
      <section className="relative pt-40 pb-24 px-6">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-12 duration-700">
            <button 
              onClick={() => openAuth('signup')}
              className="w-full sm:w-auto px-10 py-5 bg-emerald-600 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-emerald-700 hover:scale-105 transition-all shadow-2xl shadow-emerald-200 flex items-center justify-center gap-3 group"
            >
      ...
      <section className="py-24 px-6 bg-slate-900 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <button 
            onClick={() => openAuth('signup')}
            className="px-12 py-6 bg-emerald-600 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-emerald-500 hover:scale-105 transition-all shadow-2xl"
          >
