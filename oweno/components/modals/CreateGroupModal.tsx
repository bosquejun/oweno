                ...
                <div className="flex gap-2">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border-2 border-slate-50 focus:border-emerald-500 focus:bg-white rounded-2xl pl-12 pr-5 py-4 font-bold text-sm transition-all focus:outline-none"
                    />
                  </div>
                  {isEmailInput && (
                    <button 
