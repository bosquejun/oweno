  ...
  if (!group || isGroupError) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
        ...
        <Link to="/groups" className="px-8 py-3 bg-emerald-600 text-white rounded-2xl font-black shadow-xl hover:bg-emerald-700 transition-all active:scale-95 text-xs uppercase tracking-widest">
           Back to My Groups
        </Link>
      </div>
    );
      ...
      <div className="page-transition">
        <header className="sticky top-0 z-30 -mx-6 px-6 pt-8 pb-4 bg-[#F8FAFC]/90 backdrop-blur-xl flex flex-row items-center justify-between gap-4 mb-6 md:mb-10">
          <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
            <Link to="/groups" className="p-2 -ml-2 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all shrink-0">
              <ArrowLeft size={22} />
            </Link>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <section className="bg-white rounded-[2.5rem] p-6 md:p-8 shadow-sm border border-slate-100">
              <div className="flex items-center justify-between mb-8">
                ...
                <Link to={`/groups/${group.id}/history`} className="flex items-center gap-2 text-[10px] font-black text-emerald-600 uppercase tracking-widest hover:bg-emerald-50 px-3 py-2 rounded-xl transition-all">
                  <History size={14} />
                  History
                </Link>
              </div>
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                {expenses.length > 10 && (
                  <Link to={`/groups/${group.id}/history`} className="block text-center py-4 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] hover:text-emerald-600 transition-colors">
