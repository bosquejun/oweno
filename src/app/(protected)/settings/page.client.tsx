				...
				reset(
					{
						...
						preferredCurrency: updatedUser.preferredCurrency || "PHP",
						...
						<div className="flex flex-col items-center gap-6 pb-8 border-b border-slate-100">
							...
							<div className="text-center">
								...
								<p className="text-xs text-slate-500 font-medium">
									Click the refresh button to generate a new avatar
								</p>
							</div>
						</div>
					...
					<div className="relative z-10 flex items-start gap-4">
						...
						<div>
							...
							<p className="text-sm text-slate-300 font-medium leading-relaxed">
								Your preferences are saved automatically. Changes take effect immediately across all
