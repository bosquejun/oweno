...
export const createExpense = async (expenseInput: Omit<ExpenseCreateInput, 'splits' | 'group' | 'paidBy' > & {splits: Pick<Split, 'amount' | 'userId'>[], group: Pick<Group, 'id'>, paidBy: Pick<User, 'id'>}) => {
...
export const updateExpense = async (id: string, expenseInput: Omit<ExpenseUpdateInput, 'id' | 'group' | 'paidBy' | 'splits' > & {splits: Pick<Split, 'amount' | 'userId'>[], group: Pick<Group, 'id'>, paidBy: Pick<User, 'id'>}) => {
