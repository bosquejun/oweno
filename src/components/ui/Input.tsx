		...
		return (
			<div className="space-y-1.5 w-full min-w-0">
				...
				<div className="relative group w-full min-w-0">
					{Icon && (
						<div
							className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors pointer-events-none z-10 ${error ? "text-rose-400" : "text-slate-300 group-focus-within:text-emerald-500"}`}
						>
							<Icon size={18} />
						</div>
					)}
              ...
              ${
								error
									? "border-rose-300 bg-rose-50 text-rose-900 placeholder:text-rose-400 focus:border-rose-500 focus:bg-white focus:ring-rose-500/10"
									: "border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500/10"
							}
