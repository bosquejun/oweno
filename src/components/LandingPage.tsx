					...
					<div className="flex items-center gap-4">
						<SignedOut>
							<SignInButton mode="modal">
								<div className="cursor-pointer text-xs font-black text-slate-600 hover:text-emerald-600 transition-colors uppercase tracking-widest">
									Sign In
								</div>
							</SignInButton>
							<SignUpButton mode="modal">
								<div className="cursor-pointer px-6 py-3 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-xl active:scale-95">
									Join Now
								</div>
							</SignUpButton>
						</SignedOut>
						<SignedIn>
							<Link
								href="/dashboard"
								className="text-xs font-black text-slate-600 hover:text-emerald-600 transition-colors uppercase tracking-widest"
							>
								Dashboard
							</Link>
							<UserButton />
			...
			<section className="relative pt-40 pb-24 px-6">
				<div className="max-w-7xl mx-auto text-center relative z-10">
					...
					<p className="max-w-2xl mx-auto text-slate-500 text-lg md:text-xl font-medium mb-12 animate-in fade-in slide-in-from-bottom-10 duration-700">
						Designed to avoid those awkward "Sino nagbayad, bes?" moments, OweNah makes splitting
						bills simple, transparent, and drama-free.
					</p>
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-12 duration-700">
						<SignedOut>
							<SignUpButton mode="modal" forceRedirectUrl="/dashboard">
								<div className="cursor-pointer w-full sm:w-auto px-10 py-5 bg-emerald-600 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-emerald-700 hover:scale-105 transition-all shadow-2xl shadow-emerald-200 flex items-center justify-center gap-3 group">
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-20">
						...
						<p className="text-slate-500 font-medium max-w-xl mx-auto">
							Everything you need to keep your barkada's finance drama-free and your friendships
							intact.
						</p>
					</div>
			...
			<section className="py-24 px-6 bg-slate-900 overflow-hidden relative">
				...
				<div className="max-w-4xl mx-auto text-center relative z-10">
					...
					<p className="text-slate-400 text-lg mb-12">
						Join 50,000+ Filipinos splitting bills the Owenah way.
					</p>
					<SignedOut>
						<SignUpButton mode="modal">
							<button className="cursor-pointer px-12 py-6 bg-emerald-600 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-emerald-500 hover:scale-105 transition-all shadow-2xl">
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
						...
						<p className="text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">
							© 2025 OweNah Philippines. Gawa ng Barkada para sa Barkada.
						</p>
